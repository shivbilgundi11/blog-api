 ...
 * @description Middleware to verify the user's access token from the Authorization header, If the token is valid, the user's Id os attached to the request object. Otherwise, it returns an appropriate error response
 *
 * @param {Requet} req - Express request object. Expects a bearer token in the Autherization header.
